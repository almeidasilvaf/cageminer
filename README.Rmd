...
The goal of `cageminer` is to integrate SNP data from GWAS with gene coexpression networks to identify high-confidence candidate genes involved in a particular phenotype.
